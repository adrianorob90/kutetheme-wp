        ...
        <div class="container main-header">
            <div class="row">
                <div class="col-xs-12 col-sm-3 logo">
                    <a href="index.html"><img alt="Kute Shop" src="assets/data/option7/logo.png" /></a>
                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-6 col-md-3">
                    <div class="item">
                        <a href="#">
                            <img src="assets/data/option7/s1.png" alt="Service">
                ...
                <div class="col-sm-6 col-md-3">
                    <div class="item">
                        <a href="#">
                            <img src="assets/data/option7/s2.png" alt="Service">
                ...
                <div class="col-sm-6 col-md-3">
                    <div class="item">
                        <a href="#">
                            <img src="assets/data/option7/s3.png" alt="Service">
                ...
                <div class="col-sm-6 col-md-3">
                    <div class="item">
                        <a href="#">
                            <img src="assets/data/option7/s4.png" alt="Service">
