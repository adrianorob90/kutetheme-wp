...
function twentyfifteen_upgrade_notice() {
	$message = sprintf( __( 'Twenty Fifteen requires at least WordPress version 4.1. You are running version %s. Please upgrade and try again.', 'kutetheme' ), $GLOBALS['wp_version'] );
...
function twentyfifteen_customize() {
	wp_die( sprintf( __( 'Twenty Fifteen requires at least WordPress version 4.1. You are running version %s. Please upgrade and try again.', 'kutetheme' ), $GLOBALS['wp_version'] ), '', array(
		'back_link' => true,
	) );
}
...
function twentyfifteen_preview() {
	if ( isset( $_GET['preview'] ) ) {
		wp_die( sprintf( __( 'Twenty Fifteen requires at least WordPress version 4.1. You are running version %s. Please upgrade and try again.', 'kutetheme' ), $GLOBALS['wp_version'] ) );
	}
}
